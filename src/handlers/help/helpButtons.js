...
export const helpBackButton = {
  ...
  async execute(interaction, client) {
    try {
      ...
      /*
       * The old createInitialHelpMenu() function was located in
       * the deleted Core/help.js file.
       *
       * The current help system should use the existing help
       * select-menu implementation instead.
       */
      ...
      if (
        ...
        logger.warn(
          ...
          {
            event:
              'interaction.help.button.unavailable',
...
export const helpBugReportButton = {
  ...
  async execute(interaction, client) {
    const githubButton = new ButtonBuilder()
      ...
      .setURL(
        'https://github.com/codebymitch/TitanBot/issues'
      );
    ...
    bugReportEmbed.setFooter({
      text: 'FruityINC Bug Reporting System',
